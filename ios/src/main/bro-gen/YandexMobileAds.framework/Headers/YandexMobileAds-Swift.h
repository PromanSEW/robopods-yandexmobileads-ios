...
/// \param audioSessionManager A reference to the object of the AudioSessionManager class that invoked the method.
///
...
/// For receiving an adaptive anchor banner located at the top or bottom of the screen use <code>stickySize(withContainerWidth:)</code>,
...
/// An object that implements the <code>NativeBulkAdLoaderDelegate</code> protocol that tracks the progress of bulk native ad loading.
...
/// nitializes an object of the <code>NativeVideoPlaybackControls</code> class with progress control and mute control.
/// \param progressControl An object of the <code>UIView</code> class and conform to protocol <code>NativeVideoPlaybackProgressControl</code>.
///
